...
export async function getServerSideProps() {
  ...
  const apiKey = process.env.GOOGLE_SHEETS_API_KEY || 'AIzaSyDIcqb7GydD5J5H9O_psCdL1vmH5Lka4l8'; // Use Vercel env or fallback
  ...
  try {
    ...
    return { props: { tankData: desiredTanks.map(tank => tankMap[tank]) } };
  } catch (error) {
